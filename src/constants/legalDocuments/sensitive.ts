...
export const SENSITIVE_INFO_DOCUMENT: LegalDocument = {
  ...
  blocks: [
    ...
    {
      type: 'paragraph',
      text: '1. Mio는 외부 생성형 인공지능 처리업체와 회사가 자체 구성한 안전·보안 정책 시스템을 이용하여 대화와 행동 제안을 생성합니다.',
    },
    {
      type: 'paragraph',
      text: '2. 외부 인공지능 처리업체에는 응답 생성에 필요한 현재 입력과 최소 문맥만 전송합니다. 계정 식별자, 이메일, 연락처와 같은 직접 식별정보는 전송 내용에서 제거합니다.',
    },
    {
      type: 'paragraph',
      text: '3. 전송 정보는 외부 인공지능 처리업체와 해당 업체가 공개한 하위처리자 소재 국가에서 처리될 수 있으며 서비스 제공과 오남용 방지를 위해 최대 30일간 보관될 수 있습니다.',
    },
    {
      type: 'paragraph',
