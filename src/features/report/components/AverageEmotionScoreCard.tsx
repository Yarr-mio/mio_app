...
import { EMOTION_SCORE_MAX, REPORT_CARD_TITLES, type ReportPeriod } from '@/constants/report';
...
export function AverageEmotionScoreCard({ period, anchorDate }: AverageEmotionScoreCardProps) {
  const { avgEmotionScore } = useEmotionConstellationData(period, anchorDate);
